...
public final class CookieUtils {
	 ...
	 * @param request
	 * @return
	 * @create_time 2015年3月18日 下午3:29:47
	 */
	public static String getCookiesid(HttpServletRequest request) {
		return getCookieValue(request, "cookiesid");
	}
	...
	public static String getSid(HttpServletRequest request) {
		/** 如果没有则从cookie中获取 */
		String sid = request.getParameter("cookiesid");
		if(StringUtils.isBlank(sid)){
			sid=(String) request.getAttribute("cookiesid");
			if(StringUtils.isBlank(sid)){
				sid = CookieUtils.getCookiesid(request);
			}
		}
		return sid;
	}
