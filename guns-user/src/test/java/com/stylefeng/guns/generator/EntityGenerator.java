...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/ciggar/cskaoyan/csworkspace/guns/guns-user/src/main/java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"wallet_oper_log"});
